...
namespace ADO
{
    public partial class MDIForm : Form
    {
        ...
        public MDIForm()
        {
            ...
            //menu1.Click += (object sender, EventArgs e) => ShowChild("ADO.FormCommandes");
            menu2.Click += (object sender, EventArgs e) => ShowChild("ADO.FormFournisseurs");
            //je m'abonne à l'evennement menu3 avec une expression lambda.
            menu3.Click += (object sender, EventArgs e) => ShowChild("ADO.FormProduits");
            listeCommandeToolStripMenuItem.Click += (object sender, EventArgs e) => ShowChild("ADO.FormCommandes");
            détailCommandeToolStripMenuItem.Click += (object sender, EventArgs e) => ShowChild("ADO.FormListeCommande");
            this.Text = Properties.Resources.Northwind;
